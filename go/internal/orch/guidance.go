...
// Mirrors the Python orchestrator's _repo_guidance().
func (o *Orchestrator) repoGuidance() string {
	if !o.repoGuidanceCacheSet {
		o.repoGuidanceCache = readRepoGuidance(strp(o.input.RepoPath))
		o.repoGuidanceCacheSet = true
		if o.repoGuidanceCache != "" {
			fmt.Printf("[PR-AF] Applying repo review guidance from AGENTS.md (%d chars)\n",
